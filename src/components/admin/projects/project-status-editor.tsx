  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      {open ? (
        <div
          role="listbox"
          className="absolute left-0 top-full z-30 mt-1.5 w-44 overflow-hidden rounded-md border border-border bg-surface shadow-[0_8px_24px_-12px_rgba(0,0,0,0.18)]"
        >
