...
export function NewProjectDrawer({ contacts }: { contacts: ContactRow[] }) {
  ...
  async function submit(e: React.FormEvent<HTMLFormElement>) {
    ...
    setBusy(true);
    try {
      const dollars = Number(budgetDollars) || 0;
        ...
        <form onSubmit={submit} className="flex flex-1 flex-col overflow-hidden">
          <div className="flex-1 space-y-5 overflow-y-auto px-6 py-6">
            <div className="space-y-1.5">
              ...
              <p className="font-sans text-xs text-ink-subtle">
                Creating a project promotes this contact to the Clients view.
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="p_budget">Budget (USD)</Label>
                <Input
                  id="p_budget"
                  type="number"
                  min={0}
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="p_end">End date</Label>
                <Input
                  id="p_end"
                  type="date"
                  value={endDate}
          ...
          <footer className="flex items-center justify-end gap-2 border-t border-border bg-surface px-6 py-4">
            ...
            <Button
              type="submit"
              size="sm"
              disabled={busy || !contactId || !name.trim()}
            >
